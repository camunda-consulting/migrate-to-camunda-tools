...
public class BPMNDiagramGenerator {
    public static void main(String[] args)  {
        try {
            ...
            definitions.setAttributeValueNs("http://camunda.org/schema/modeler/1.0","executionPlatform","Camunda Cloud");
            //definitions.setAttributeValue("modeler:executionPlatform","Camunda Cloud", false);
